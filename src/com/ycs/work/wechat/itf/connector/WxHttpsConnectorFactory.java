...
import com.ycs.work.wechat.itf.connector.impl.WxHttpsConnector;
import com.ycs.work.wechat.itf.exception.HiITFException;


/**
 * @description 微信https连接
 * @author youcyousyunn
 * @date 2018年11月6日
 */
public class WxHttpsConnectorFactory implements WxIConnectorFactory {
    ...
    public WxIConnector build() throws HiITFException {
        ...
        WxHttpsConnector connector = new WxHttpsConnector();
