...
/**
 * @description 微信http请求
 * @author youcyousyunn
 * @date 2018年11月6日
 */
public class WxHttpConnector implements WxIConnector {
        ...
        try {
            ...
            if ("POST".equals(methodTyp)) {
                ...
                if ("keyValue".equals(bodyTyp)) {
                    NameValuePair[] pair = new BasicNameValuePair[param.size()];
                    int i = 0;
                ...
                if ("json".equals(bodyTyp)) {
                    StringEntity entity = new StringEntity((String) param.get("json"), "UTF-8");
                ...
                if ("xml".equals(bodyTyp)) {
                    StringEntity entity = new StringEntity((String) param.get("xml"), "UTF-8");
                    entity.setContentEncoding(entityBuilder.getContentEncoding());
                ...
                if ("keyValueAndJson".equals(bodyTyp)) {
                    ...
                    String [] keys = String.valueOf(param.get("key")).split("\\|");
                    String [] valus = String.valueOf(param.get("value")).split("\\|");
            ...
            if (status == HttpStatus.SC_OK || status == HttpStatus.SC_MOVED_PERMANENTLY
                ...
                throw new HiITFException(HiMsgCdConstants.ITF_SEND_FAIL, "Http Response code[" + status + "]");
            }
