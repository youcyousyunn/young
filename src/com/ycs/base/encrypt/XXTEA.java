...
public class XXTEA {
	...
	public static void main(String[] args) throws IOException {
		...
		String encriptPwd = encryptWithBase64(pwd, SystemPropertyConfigure.XXTEA_KEY.getBytes(), null);
		System.out.println("加密后密码："+encriptPwd);
		String decryptPwd = new String(decryptWithBase64(encriptPwd, SystemPropertyConfigure.XXTEA_KEY.getBytes(), null));
