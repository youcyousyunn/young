...
/**
 * @description 返回流程单据信息
 * @author youcyousyunn
 * @date 2018年10月7日
 */
public class QryFlowOrdInfoResponseDto extends BaseResponseDto {
    ...
    public String toString() {
        return "QryFlowOrdInfoResponseDto [flowOrd=" + flowOrd + ", ordNo=" + ordNo + ", txDt=" + txDt + ", txTm="
                + txTm + ", expDt=" + expDt + ", expTm=" + expTm + ", actionStep=" + actionStep + ", downStep="
                + downStep + ", sendCnl=" + sendCnl + ", accpCnl=" + accpCnl + ", flowSts=" + flowSts + ", lunchUsrNo="
                + lunchUsrNo + ", recevUsrNo=" + recevUsrNo + ", endDt=" + endDt + ", endTm=" + endTm + ", isFollow="
                + isFollow + ", flowNo=" + flowNo + ", flowAction=" + flowAction + "]";
    }
}
